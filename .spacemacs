...
(custom-set-variables
 ...
 '(TeX-command-list
   (quote
    (("xelatex" "%`xelatex --synctex=1%(mode)%' %T" TeX-run-TeX t
 ...
 '(TeX-expand-list (quote (("%(dir)" (lambda nil default-directory) nil))))
 ...
 '(package-selected-packages
   (quote
    (nadvice monokai-theme zmq julia-mode ivy python-environment epc ctable concurrent cdlatex yasnippet memoize auto-complete-auctex smex treemacs ht pfuture helm-company helm-c-yasnippet fuzzy company-statistics auto-yasnippet ac-ispell py-autopep8 poly-org poly-R poly-noweb poly-markdown org-ref pdf-tools key-chord helm-bibtex biblio parsebib biblio-core tablist org-pretty-tags magic-latex-buffer latex-preview-pane latex-pretty-symbols latex-extra company-anaconda company-auctex auctex-latexmk auctex git-commit with-editor color-identifiers-mode auto-dictionary company ein skewer-mode markdown-mode polymode deferred auto-complete websocket js2-mode simple-httpd evil-matchi anaconda-mode unfill smeargle rainbow-identifiers orgit org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-mime org-download mwim magit-gitflow magit-popup htmlize helm-gitignore gnuplot gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link flyspell-correct-helm flyspell-correct flycheck-pos-tip pos-tip flycheck evil-magit magit transient rainbow-mode yapfify pyvenv pytest pyenv-mode py-isort pip-requirements live-py-mode hy-mode dash-functional helm-pydoc cython-mode anaconda-mode pythonic ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox spinner org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint indent-guide hydra lv hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-projectile projectile pkg-info epl helm-mode-manager helm-make helm-flx helm-descbinds helm-ag google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist highlight evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu elisp-slime-nav dumb-jump f dash s diminish define-word column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line helm avy helm-core popup async)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "YaHei Consolas Hybrid" :foundry "MS  " :slant normal :weight normal :height 113 :width normal)))))
